            ...
            children: [
              Expanded(
                child: FooterBaseView(
                  isCenter: (
                     ! _isLoggedIn || locationController.addressList == null || locationController.addressList!.length == 0),
                  child: SizedBox(
              ...
              if(!ResponsiveHelper.isDesktop(context))
              BottomButton(locationController: Get.find<LocationController>(), fromSignUp: fromSignUp!, route: route),
            ],
          );
          }
        ),
...
class BottomButton extends StatelessWidget {
  ...
  @override
  Widget build(BuildContext context) {
    return Center(child: SizedBox(width: GetPlatform.isMobile ? MediaQuery.of(context).size.width-40 : 700, child: Column(children: [
      ...
      TextButton(
        ...
        child: Row(mainAxisAlignment: MainAxisAlignment.center, children: [
          ...
          Text('set_from_map'.tr, textAlign: TextAlign.center, style: ubuntuBold.copyWith(
