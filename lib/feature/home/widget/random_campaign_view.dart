          ...
          if(campaignController.campaignList != null && campaignController.campaignList!.length == 0){
            ...
            if(campaignController.campaignList != null) {
                    ...
                    Padding(
                      ...
                      child: Container(
                        ...
                        child: ClipRRect(
                          ...
                          child: CustomImage(
                            height: GetPlatform.isDesktop ? 500 : MediaQuery.of(context).size.width * 0.35, width: Get.width, fit: BoxFit.cover, placeholder: Images.dummyBanner,
              ...
              return Container(
                ...
                height: GetPlatform.isDesktop ? 500 : MediaQuery.of(context).size.width * 0.35,
