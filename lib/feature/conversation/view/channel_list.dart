                  ...
                  children: [
                    ...
                    ListView.builder(
                        ...
                        itemBuilder: (context,index){
                          ...
                          if(xyz) print('user tye===> ${controller.channelList![index].channelUsers![0].user!.userType}/${controller.channelList![index].channelUsers![1].user!.userType}');
                          return xyz? ChannelItem(
