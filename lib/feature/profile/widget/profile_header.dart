                    ...
                    children: [
                      ClipRRect(
                        ...
                        child: CustomImage(
                          width: 130.0,
                          height: 130.0,
                          image:_isLoggedIn ? userInfoModel.image != null ? Get.find<SplashController>().configModel.content!.imageBaseUrl!+"/user/profile_image/"+userInfoModel.image! : '':'',
                        ),
                      ),
                  ...
                  _isLoggedIn ? Row(
                    ...
                    children: [
                      ...
                      ColumnText(
                        ...
                        accountAgo: Get.find<UserController>().createdAccountAgo,
                        amount: 340,
