                ...
                child: SizedBox(
                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        ServiceViewVertical(service: searchController.searchServiceList!,noDataType: NoDataType.SEARCH,),
                      ],
                    )));
          }else{
            return searchController.historyList!.length > 0 ?  SearchSuggestion():SizedBox();
          }
