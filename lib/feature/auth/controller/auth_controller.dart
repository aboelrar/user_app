    ...
    if(_isValid){
      ...
      if (response!.statusCode == 200) {
        ...
        ScaffoldMessenger.of(Get.context!).showSnackBar(SnackBar(
          content: Text('registration_200'.tr), backgroundColor: Colors.green,
        ...
        ScaffoldMessenger.of(Get.context!).showSnackBar(SnackBar(
          content: Text('${_errorResponse.responseCode}_${_errorResponse.errors!.elementAt(0).errorCode!}'.tr,style: ubuntuRegular.copyWith(color: Colors.white),),
      ...
      ScaffoldMessenger.of(Get.context!).showSnackBar(SnackBar(content: Text('phone_number_with_valid_country_code'.tr),
          behavior: SnackBarBehavior.floating,
          backgroundColor: Colors.red));
    }
  }
