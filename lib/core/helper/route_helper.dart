...
class RouteHelper {
  ...
  static String getOrderSuccessRoute( String status) => '$orderSuccess?status=$status';
  ...
  static String allServiceScreenRoute(String fromPage) => '$allServiceScreen?fromPage=$fromPage';
  ...
  static List<GetPage> routes = [
    ...
    GetPage(
        ...
        page: () {return getRoute(Get.arguments != null ? Get.arguments : ServiceDetailsScreen(serviceID: Get.parameters['id']!));}),
    ...
    GetPage(
      ...
      GetPage(
          name: orderSuccess,
          page: () => getRoute(OrderSuccessfulScreen(status: Get.parameters['status']!.contains('success') ? 1 : 0,))
      ),
      GetPage(binding: CheckoutBinding(), name: checkout, page: () => getRoute(CheckoutScreen())),
      GetPage(
      ...
      GetPage(
          ...
          page: () {
            ...
            String _data = utf8.decode(_decode);
            return getRoute(CategorySubCategoryScreen(categoryID: Get.parameters['id']!,categoryName: _data));
      }),
    ...
    GetPage(name: chatScreen, page: () => getRoute(
      ...
      GetPage(binding: ServiceBinding(),name: allServiceScreen, page:  ()=> getRoute(AllServiceView(fromPage: Get.parameters['fromPage']!,)),),
